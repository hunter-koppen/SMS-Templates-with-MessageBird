...
public class ReplaceSMSTemplateTokens extends CustomJavaAction<java.lang.Boolean>
{
	private IMendixObject DataObject;
	private IMendixObject __SMSMessage;
	private smstemplates.proxies.SMSMessage SMSMessage;
	private java.util.List<IMendixObject> __TokenList;
	private java.util.List<mxmodelreflection.proxies.Token> TokenList;

	public ReplaceSMSTemplateTokens(IContext context, IMendixObject DataObject, IMendixObject SMSMessage, java.util.List<IMendixObject> TokenList)
	{
		super(context);
		this.DataObject = DataObject;
		this.__SMSMessage = SMSMessage;
	...
	{
		this.SMSMessage = __SMSMessage == null ? null : smstemplates.proxies.SMSMessage.initialize(getContext(), __SMSMessage);
		...
		Map<String, ? extends IMendixObjectMember<?>> members = this.SMSMessage.getMendixObject().getMembers(getContext());
	...
	{
		return "ReplaceSMSTemplateTokens";
	}
